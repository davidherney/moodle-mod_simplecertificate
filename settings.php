...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('simplecertificate/certificatepath', get_string('certificatepath', 'simplecertificate'),
    ...
    $opts = array('accepted_types' => array('.png', '.jpg'));
